...
ifneq "$(KERNELVERSION)" "4.19.0-rc4"
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "arm-linux-gnu-gcc (GCC) 8.1.1 20180626 (Red Hat Cross 8.1.1-3)"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "/var/valio/linux"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "arm-linux-gnu-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "arm-linux-gnu-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
